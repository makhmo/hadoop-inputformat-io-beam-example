...
/**
 * A helper class {@link AvroToOrcStructFn} that converts a OrcStruct {@link OrcStruct} to a
 * GenericRecord {@link GenericRecord}
 */
public class AvroToOrcStructFn extends SimpleFunction<GenericRecord, OrcStruct> {

  private String schemaString;
  private static final Logger LOG = LoggerFactory.getLogger(AvroToOrcStructFn.class);

  public AvroToOrcStructFn(String schemaString) {
